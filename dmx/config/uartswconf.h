...
#define UARTSW_TX_PORT			PDR5	///< UART Transmit Port
#define UARTSW_TX_DDR			DDR5	///< UART Transmit DDR
#define UARTSW_TX_PIN			PDR51	///< UART Transmit Pin

// UART receive pin defines
// This pin must correspond to the
// Timer1 Input Capture (ICP or IC1) pin for your processor
#define UARTSW_RX_PORT			PDR5	///< UART Receive Port
#define UARTSW_RX_DDR			DDR5	///< UART Receive DDR
#define UARTSW_RX_PORTIN		PDR5	///< UART Receive Port Input
#define UARTSW_RX_PIN			PDR52	///< UART Receive Pin
